...
export class AddTBLOrdersShippingOp1710954248801 implements MigrationInterface {
    name = 'AddTBLOrdersShippingOp1710954248801'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "orders_products" ("id" SERIAL NOT NULL, "productUnitPrice" numeric(10,2) NOT NULL DEFAULT '0', "productQuantity" integer NOT NULL, "orderId" integer, "productId" integer, CONSTRAINT "PK_4945c6758fd65ffacda760b4ac9" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "users" ALTER COLUMN "lastPasswordChangedAt" SET DEFAULT '"2024-03-20T17:04:09.619Z"'`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "users" ALTER COLUMN "lastPasswordChangedAt" SET DEFAULT '2024-03-19 04:24:38.531'`);
